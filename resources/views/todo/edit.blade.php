...
<body>
    ...
    <section class="m-5 d-flex justify-content-center">
        <form action="/update/{{ $todo->id }}" style="width: 700px" class="bg-light p-4 shadow mb-5 bg-body rounded">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="details" class="form-control" id="details" value="{{ $todo->details }}">
            </div>
            <div class=" text-center">
